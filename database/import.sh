...
mongoimport --host mongodb -u attackSeaman -p cuccs1sgreat --db attackSeaman --collection mitre_attack --drop --type json --file /database/enterprise-attack.json --jsonArray
